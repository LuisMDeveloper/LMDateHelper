...
Pod::Spec.new do |s|
  s.name             = 'LMDateHelper'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LMDateHelper.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Luis Manuel Ramirez Vargas/LMDateHelper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Luis Manuel Ramirez Vargas' => 'luis.manuel.ramirez.91@gmail.com' }
  s.source           = { :git => 'https://github.com/Luis Manuel Ramirez Vargas/LMDateHelper.git', :tag => s.version.to_s }
